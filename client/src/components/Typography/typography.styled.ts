...
const paragraphFont = secondaryFont.style.fontFamily.startsWith("'") ? secondaryFont.style.fontFamily : `'${secondaryFont.style.fontFamily}'`
const headingFont = mainFont.style.fontFamily.startsWith("'") ? mainFont.style.fontFamily : `'${mainFont.style.fontFamily}'`
